...
export default function AdminGiangVienImportPopup(props: Props) {
  const {
    open,
    importBusy,
    importFile,
    ...
    <MessagePopup
      ...
      actions={
        <>
          ...
          <button type="button" className={`${styles.btn} ${styles.btnPrimary}`} disabled={importBusy} onClick={onSubmitImport}>
            Tạo
          </button>
        </>
      }
